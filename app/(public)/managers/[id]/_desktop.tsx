  ...
  return (
    <div className="max-w-7xl mx-auto space-y-6">
      ...
      <div className="card overflow-hidden">
        <div className="bg-gradient-to-br from-bg-base via-accent/10 to-bg-surface h-36 relative" />
        <div className="px-10 py-8 -mt-16 relative flex items-end gap-8">
          <div className="relative shrink-0">
            ...
            {currentTeam?.logo_team_slug && (
              <div className="absolute bottom-0 right-0 translate-x-1/4 translate-y-1/4 w-9 h-9 rounded-full bg-bg-surface shadow-md flex items-center justify-center overflow-hidden">
                <Image
          ...
          <div className="flex gap-8 pb-1">
             <div className="text-center">
                <p className="text-3xl font-black text-text-primary">{stats.played}</p>
        ...
        <div className="space-y-6">
          <div className="card p-6">
            <h2 className="text-sm font-black text-text-primary uppercase tracking-widest flex items-center gap-2 mb-4">
              <ClipboardList className="w-5 h-5 text-accent" /> Profile Details
            </h2>
          ...
          <div className="card p-6">
            <h2 className="text-sm font-black text-text-primary uppercase tracking-widest flex items-center gap-2 mb-4">
              <BarChart3 className="w-5 h-5 text-accent" /> Career Statistics
            </h2>
            <div className="grid grid-cols-2 gap-4">
              <div className="p-4 rounded-xl bg-bg-elevated/50 border border-border/50">
                ...
                <p className="text-2xl font-black text-feedback-success">{stats.wins}</p>
              </div>
              <div className="p-4 rounded-xl bg-bg-elevated/50 border border-border/50">
                <p className="text-xs text-text-muted mb-1 font-bold">Draws</p>
                <p className="text-2xl font-black text-feedback-warning">{stats.draws}</p>
              </div>
              <div className="p-4 rounded-xl bg-bg-elevated/50 border border-border/50">
                <p className="text-xs text-text-muted mb-1 font-bold">Losses</p>
                <p className="text-2xl font-black text-feedback-error">{stats.losses}</p>
              </div>
              <div className="p-4 rounded-xl bg-bg-elevated/50 border border-border/50">
                ...
                <table className="w-full text-sm">
                  <thead>
                    <tr className="border-b-2 border-accent/30 bg-bg-base">
                      <th className="text-left py-3.5 pr-4 text-[11px] font-bold text-text-muted uppercase tracking-wider">Club</th>
                      <th className="text-left py-3.5 px-4 text-[11px] font-bold text-text-muted uppercase tracking-wider">Period</th>
                      <th className="text-center py-3.5 px-3 text-[11px] font-bold text-text-muted uppercase tracking-wider">P</th>
                      <th className="text-center py-3.5 px-3 text-[11px] font-bold text-text-muted uppercase tracking-wider">W</th>
                      <th className="text-center py-3.5 px-3 text-[11px] font-bold text-text-muted uppercase tracking-wider">D</th>
                      <th className="text-center py-3.5 px-3 text-[11px] font-bold text-text-muted uppercase tracking-wider">L</th>
                      <th className="text-center py-3.5 px-3 text-[11px] font-bold text-text-muted uppercase tracking-wider">WR</th>
                      <th className="text-center py-3.5 pl-3 text-[11px] font-bold text-text-muted uppercase tracking-wider">GD</th>
                    </tr>
                  </thead>
                  <tbody>
                    {tenures.map((tenure: any) => {
                      ...
                      return (
                        ...
                        >
                          <td className="py-4 pr-4 min-w-0">
                            <div className="flex items-center gap-3">
                              ...
                              <div className="min-w-0">
                                ...
                                {isCurrent && (
                                  <span className="ml-2 text-[9px] bg-accent/20 text-accent border border-accent/30 px-1.5 py-0.5 rounded-full font-black uppercase align-middle shrink-0">Active</span>
                                )}
                              </div>
                            </div>
                          </td>
                          ...
                          <td className="text-center py-4 px-3 font-semibold text-text-primary">{played}</td>
                          ...
                          <td className="text-center py-4 px-3 font-semibold text-text-primary">{tWinRate}%</td>
                          <td className="text-center py-4 pl-3 font-semibold text-text-primary">{tenure.goals_for - tenure.goals_against}</td>
                        </tr>
                      )
                    })}
                  </tbody>
