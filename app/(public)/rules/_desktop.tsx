    ...
    <div className="max-w-7xl mx-auto space-y-6">
      ...
      <div className="grid grid-cols-2 gap-6">
        ...
        <div className="space-y-6">
          <section className="bg-bg-elevated border border-border rounded-xl p-5 space-y-4">
            <div className="flex items-center gap-3">
              <div className="w-1 h-6 rounded-full bg-accent" />
              <h2 className="text-lg font-bold text-text-primary">EFA Official Match Rules</h2>
            </div>
          ...
          <section className="bg-bg-elevated border border-border rounded-xl p-5 space-y-4">
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-lg font-bold text-text-primary">Abandonment Rules</h2>
            </div>
            ...
            <div className="space-y-3">
              ...
              <div className="space-y-2">
                <div className="flex gap-3 p-3.5 rounded-lg bg-green-500/10 border border-green-500/20 hover:bg-green-500/20 transition-colors">
                ...
                <div className="flex gap-3 p-3.5 rounded-lg bg-blue-500/10 border border-blue-500/20 hover:bg-blue-500/20 transition-colors">
                ...
                <div className="flex gap-3 p-3.5 rounded-lg bg-red-500/10 border border-red-500/20 hover:bg-red-500/20 transition-colors">
          ...
          <section className="bg-bg-elevated border border-border rounded-xl p-5 space-y-4">
            <div className="flex items-center gap-3">
              <div className="w-1 h-6 rounded-full bg-accent" />
              <h2 className="text-lg font-bold text-text-primary">Matchroom Instructions</h2>
            </div>
            ...
            <div className="space-y-2">
              ...
              {[
                ...
                <div
                  key={i}
                  className="flex items-start gap-3 py-2.5 px-3 rounded-lg bg-bg-surface border border-border hover:bg-bg-surface/80 transition-colors"
                >
        ...
        <div className="space-y-6">
          <section className="bg-bg-elevated border border-border rounded-xl p-5 space-y-4">
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-lg font-bold text-text-primary">Disconnect Rules</h2>
            </div>
            <p className="text-sm text-text-muted leading-relaxed">
              ...
              <table className="w-full text-sm">
                ...
                <tbody>
                  {DISCONNECT_RULES.map((row, i) => (
                    <tr
                      key={i}
                      className={`border-b border-border/60 hover:bg-black/[0.05] transition-colors ${
          ...
          <section className="bg-bg-elevated border border-border rounded-xl p-5 space-y-4">
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-lg font-bold text-text-primary">Anti-Forfeit Rule</h2>
            </div>
            <div className="flex gap-4 p-4 rounded-lg bg-orange-500/10 border border-orange-500/20 hover:bg-orange-500/20 transition-colors">
          ...
          <section className="bg-bg-elevated border border-border rounded-xl p-5 space-y-4">
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-lg font-bold text-text-primary">No-Postponements Policy</h2>
            </div>
            <div className="flex gap-4 p-4 rounded-lg bg-rose-500/10 border border-rose-500/20 hover:bg-rose-500/20 transition-colors">
