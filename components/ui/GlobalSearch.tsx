...
export default function GlobalSearch() {
  ...
  if (!open) {
    return (
      <button
        ...
        className="p-2 rounded-lg hover:bg-bg-elevated transition-colors text-text-muted hover:text-accent"
        title="Search"
      >
  ...
  return (
    <div ref={containerRef} className="relative">
      ...
      {query.length >= 2 && (
        <div className="absolute top-full mt-1 left-0 right-0 bg-bg-elevated border border-border rounded-xl shadow-2xl z-50 max-h-[70vh] overflow-y-auto">
          {loading ? (
