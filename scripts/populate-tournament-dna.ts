...
const TEAM_PROFILE_MAP: Record<string, ProfileName> = {
  ...
  // Argentina
  'Argentina National Team': 'Elite Dominators',

  // Europe
  'England National Team': 'Disciplined Pressers',
  'France National Team': 'Elite Dominators',
  'Germany National Team': 'Gegenpressing',
  'Spain National Team': 'Tiki-Taka',
  'Portugal National Team': 'Elite Dominators',
  'Netherlands National Team': 'Tiki-Taka',
  'Italy National Team': 'Disciplined Pressers',
  'Belgium National Team': 'Elite Dominators',
  'Croatia National Team': 'Disciplined Pressers',

  // South America
  'Brazil National Team': 'Elite Dominators',
  'Uruguay National Team': 'Gegenpressing',
  'Colombia National Team': 'Quick Counter',

  // Africa
  'Morocco National Team': 'Disciplined Pressers',
  'Senegal National Team': 'Quick Counter',
  'Algeria National Team': 'Out Wide',
  'Nigeria National Team': 'The Grinders',
  'Egypt National Team': 'Quick Counter',
  'Cameroon National Team': 'The Grinders',
  'Ghana National Team': 'Quick Counter',
  'Tunisia National Team': 'Pragmatic Stabilizers',
  'Ivory Coast National Team': 'Quick Counter',
  'Mali National Team': 'Long Ball Counter',

  // Asia
  'Japan National Team': 'Disciplined Pressers',
  'South Korea National Team': 'Quick Counter',
  'Iran National Team': 'Long Ball Counter',
  'Saudi Arabia National Team': 'Pragmatic Stabilizers',
  'Australia National Team': 'Out Wide',

  // North / Central America
  'Mexico National Team': 'Quick Counter',
  'USA National Team': 'Gegenpressing',
  'Canada National Team': 'Quick Counter',

  // Fallback patterns by region
  'Chile National Team': 'Gegenpressing',
  'Ecuador National Team': 'Quick Counter',
  'Paraguay National Team': 'Long Ball Counter',
  'Peru National Team': 'Quick Counter',
  'Costa Rica National Team': 'Long Ball Counter',
  'Panama National Team': 'Pragmatic Stabilizers',
  'Qatar National Team': 'Pragmatic Stabilizers',
  'Serbia National Team': 'The Grinders',
  'Switzerland National Team': 'Disciplined Pressers',
  'Denmark National Team': 'Disciplined Pressers',
  'Sweden National Team': 'Out Wide',
  'Norway National Team': 'Quick Counter',
  'Poland National Team': 'Long Ball Counter',
  'Ukraine National Team': 'Quick Counter',
  'Turkey National Team': 'Gegenpressing',
  'Greece National Team': 'Disciplined Pressers',
  'Czech Republic National Team': 'Disciplined Pressers',
  'Austria National Team': 'Gegenpressing',
  'Hungary National Team': 'Quick Counter',
  'Wales National Team': 'Out Wide',
  'Scotland National Team': 'The Grinders',
  'Ireland National Team': 'The Grinders',
}
