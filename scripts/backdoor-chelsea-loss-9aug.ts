/**
 * One-off: override the confirmed PSG vs Chelsea result (09 Aug) with a backdoor
 * loss to Chelsea (Chelsea absent). PSG 1-3 Chelsea -> PSG 3-0 Chelsea.
 *
 ...
 *
 * Run: npx tsx scripts/backdoor-chelsea-loss-9aug.ts
 */
...
const FIXTURE_ID = '2a336012-85ec-4369-810f-0e9158d3f5ff'
const TOURNAMENT_ID = '35adbc8e-fc5d-4311-9a26-e12e902fda3f' // EFA Premier League
const HOME_SCORE = 3 // Paris Saint Germain
const AWAY_SCORE = 0 // Chelsea absent -> backdoor loss
...
async function main() {
  ...
  // This is an override of an already-confirmed result.
  ...
  console.log('\nRecalculating standings for EFA Premier League...')
  ...
  console.log('\nDone — backdoor override applied and verified.')
}
